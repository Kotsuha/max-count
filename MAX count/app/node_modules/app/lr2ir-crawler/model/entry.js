...
function PlayDataEntry(no, title, bmsid, clear, ranking) { // プレイデータ
	this.no = no;
	this.title = title;
	this.bmsid = bmsid;
	this.clear = clear;
...
function RankingEntry(player, playerid, score) { // ランキング
	// this.ranking = ranking;
	this.player = player;
...
RankingEntry.createFrom$Row = function($row) {
	const $cells = $row.find("td");
